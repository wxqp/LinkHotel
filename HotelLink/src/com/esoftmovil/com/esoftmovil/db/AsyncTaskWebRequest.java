...
public class AsyncTaskWebRequest extends AsyncTask<String, Void, String> {
	...
	public AsyncTaskWebRequest(Context ctx, List<NameValuePair> prPostParameters)
	{
		this.AppContext=ctx;
        this.postParameters = prPostParameters;
    }
    public AsyncTaskWebRequest(Context ctx)
    {
    	this.postParameters = new ArrayList<NameValuePair>();
        this.AppContext=ctx;

    }
    public AsyncTaskWebRequest()
    {
    ...
    {
        super.onPreExecute();
        oProgressDialog=ProgressDialog.show(AppContext,null,"Cargando...");
    }
